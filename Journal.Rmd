...
# iPhone X Release, Archive Nov 25, 2017

2018 | 7 | 23 Last compiled: `r Sys.Date()`

Upon the iPhone X initial release all eyes were upon the new OLED display. No home button and a notch. Die hard Apple fans flocked to get their hands on the new device. Analysts were wary as to how a 1000 price tag would affect sales. One side claimed Apple should lower prices in the upcoming quarters. Justified by economic principles. Others stated that a higher price would create an exclusive identity and in return — create greater demand. I second the later claim. Regardless of your positioning, iPhone X is NOT worth $1000 TODAY.
The real value of the iPhone X is yet to be unlocked in the coming months — as developers build thousands of application atop the True Depth sensor and ARkit. These applications — only accessible to iPhone X users will allow them to enter a new reality (Arkit will remain less exclusive yet the experience will be superior on X). iPhone X representing their entry ticket. Discovering the possibilities of augmented reality and allowing your face to be tracked across many native and third party applications. I expect a timeline of 18 months before there is enough viable content and new use cases to justify the price of the iPhone X. Exclusive software is the iPhone X advantage. It would expected that this hardware and following software will be shared across the entire Apple lineup of products — including iPad, Mac and “lower” end phones. But for those who do not want to wait — iPhone X is your best option.
This principal holds true for what we have seen in the VR space. For example, a $1400 setup for an Oculus and compatible desktop computer may seen pricey. Yet as content is developed at record pace and unit prices slowly drop — there will be a tipping point where users feel compelled to enter VR. Software here being the main pull, not the hardware. iPhone X is adopting these same principles.
For now, users can enjoy the same content and services available on an iPhone SE for one third the price. I myself will be upgrading to the iPhone Plus series while I wait for a world of content to be developed for the X. When that time arrives — I will be in full endorsement of the X.
